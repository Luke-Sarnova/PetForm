...
class DogForm extends React.Component {
    ...
    handleSubmit = event => {
        ...
        alert(`Appointment created for ${name} on ${date}`)
    }
            ...
            <Container>
                <Row>
                    <Col md={{span: 7, offset: 3}}>
                        <Jumbotron>
                            <p> Are you or your pet new to React? Please fill out this simple 
                                form with as much of your information as you can provide, 
                                and it will be sent directly to us in preparation for your first 
                                appointment
                            </p>
                            <Form onSubmit={this.handleSubmit}>
                                ...
                                <Form.Group>
                                    <Form.Label>Does your dog have any known allergies or reactions
